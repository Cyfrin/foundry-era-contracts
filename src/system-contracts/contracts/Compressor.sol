...
//     function publishCompressedBytecode(bytes calldata _bytecode, bytes calldata _rawCompressedData)
//         external
//         payable
...
//                 initValue, finalValue, operation, _compressedStateDiffs[stateDiffPtr:stateDiffPtr + len]
//             );
//             stateDiffPtr += len;
//         }
...
//             uint256 initValue = stateDiff.readUint256(92);
//             uint256 finalValue = stateDiff.readUint256(124);
//             uint256 compressedEnumIndex =
//                 _sliceToUint256(_compressedStateDiffs[stateDiffPtr:stateDiffPtr + _enumerationIndexSize]);
...
//     ///    - N bytes: the dictionary
//     ///    - M bytes: the encoded data
//     function _decodeRawBytecode(bytes calldata _rawCompressedData)
//         internal
//         pure
//         returns (bytes calldata dictionary, bytes calldata encodedData)
//     {
//         unchecked {
...
//                 require(
//                     _initialValue - convertedValue == _finalValue, "sub: initial minus converted not equal to final"
//                 );
//             } else {
