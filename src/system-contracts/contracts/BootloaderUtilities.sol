...
//     EIP_2930_TX_TYPE,
//     EIP_1559_TX_TYPE
// } from "./libraries/MemoryTransactionHelper.sol";
...
contract BootloaderUtilities {
// using MemoryTransactionHelper for *;

// struct StackTooDeepWorkAround {
//     uint256 encodedNonceLength;
//     uint256 encodedGasParamLength;
//     uint256 encodedToLength;
//     uint256 encodedValueLength;
//     uint256 encodedDataLengthLength;
//     uint256 transactionDataLength;
//     uint256 rEncodedLength;
//     uint256 sEncodedLength;
//     uint256 vEncodedLength;
// }

// struct StackTooDeepWorkAroundTwo {
//     bytes encodedListLength;
//     bytes encodedNonce;
//     bytes encodedGasParam;
//     bytes encodedTo;
//     bytes encodedValue;
...
//     StackTooDeepWorkAround memory stdwa = StackTooDeepWorkAround({
//         encodedNonceLength: encodedNonce.length,
//         encodedGasParamLength: encodedGasParam.length,
//         encodedToLength: encodedTo.length,
//         encodedValueLength: encodedValue.length,
//         encodedDataLengthLength: encodedDataLength.length,
//         transactionDataLength: _transaction.data.length,
//         rEncodedLength: rEncoded.length,
//         sEncodedLength: sEncoded.length,
//         vEncodedLength: vEncoded.length
//     });

//     unchecked {
//         uint256 listLength = stdwa.encodedNonceLength + stdwa.encodedGasParamLength + stdwa.encodedToLength
//             + stdwa.encodedValueLength + stdwa.encodedDataLengthLength + stdwa.transactionDataLength + rEncoded.length
//             + sEncoded.length + vEncoded.length;

//         // Safe cast, because the length of the list can't be so large.
//         encodedListLength = RLPEncoder.encodeListLen(uint64(listLength));
//     }

//     StackTooDeepWorkAroundTwo memory stdwa2 = StackTooDeepWorkAroundTwo({
//         encodedListLength: encodedListLength,
//         encodedNonce: encodedNonce,
//         encodedGasParam: encodedGasParam,
//         encodedTo: encodedTo,
//         encodedValue: encodedValue,
//         encodedDataLength: encodedDataLength,
//         transactionData: _transaction.data,
//         vEncoded: vEncoded,
//         rEncoded: rEncoded,
//         sEncoded: sEncoded
//     });
...
//     return keccak256(
//         bytes.concat(
//             stdwa2.encodedListLength,
//             stdwa2.encodedNonce,
//             stdwa2.encodedGasParam,
//             stdwa2.encodedTo,
//             stdwa2.encodedValue,
//             stdwa2.encodedDataLength,
//             stdwa2.transactionData,
//             stdwa2.vEncoded,
//             stdwa2.rEncoded,
//             stdwa2.sEncoded
//         )
...
//             + encodedAccessListLength.length + rEncoded.length + sEncoded.length + vEncoded.length;
